...
<div id="header">
  ...
  <div id="nav">
    <a href="https://drive.google.com/file/d/1osjOVV0TZj6vlX2rB98HTv6kOhQcSxLF/view" target="_blank" style="background:#1a73e8;border:none;color:#fff;padding:6px 10px;border-radius:8px;font-size:12px;cursor:pointer;display:flex;align-items:center;gap:5px;text-decoration:none;white-space:nowrap;">&#128196; Drive</a>
